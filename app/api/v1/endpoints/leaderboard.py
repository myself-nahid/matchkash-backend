...
from app.schemas.match import LeaderboardMatchInfo, DetailedLeaderboardResponse, LeaderboardEntry


router = APIRouter()


@router.get("/matches", response_model=List[LeaderboardMatchInfo])
